...
def contar(mi_lista_aleatoria):
    cantidad_tres = mi_lista_aleatoria.count(3)
...
print(mi_lista_aleatoria)
    # print(lista_numeros)
cantidad_tres = contar(mi_lista_aleatoria)
print('El número 3 aparece {} veces en la lista'.format(cantidad_tres))
